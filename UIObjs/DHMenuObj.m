...
-(id) initWithWinRect: (CGRect)rect
{
	...
	if( (self=[super init]) )
    {
        ...
        menuitem_timemode.scale *= CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
        NSString* timemode_str = [NSString stringWithFormat:@"Time Mode"];
        self.timemode_label = [DHLabel labelWithString:timemode_str fontName:DHLABEL_FONT fontSize:20*[[DHGameData sharedDHGameData] getScale]];
