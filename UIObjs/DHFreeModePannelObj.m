...
-(void)initLeftDuckSprites: (CGPoint)pos
{
    ...
    for( int i = 0; i < FREEMODE_TOTAL_DUCK; i++ )
    {
        ...
        sprite1.scale *= (0.2 * CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale]);
        sprite1.position = ccp(pos.x + i*sprite1.contentSize.width*sprite1.scale + 10*[[DHGameData sharedDHGameData] getScale], pos.y);
