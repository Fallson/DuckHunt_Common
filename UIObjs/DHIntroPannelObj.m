...
-(id) initWithWinRect: (CGRect)rect andDuckNum:(int)dn andBirdNum:(int)bn andPirrotNum:(int)pn;
{
	if( (self=[super init]) )
    {
        ...
        self.duck.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
        ...
        self.duck_label = [DHLabel labelWithString:duck_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
        self.duck_label.color = [DHLabel GetColor];
        ...
        self.bird.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
        ...
        self.bird_label = [DHLabel labelWithString:bird_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
        self.bird_label.color = [DHLabel GetColor];
        ...
        self.parrot.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
        ...
        self.parrot_label = [DHLabel labelWithString:parrot_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
        self.parrot_label.color = [DHLabel GetColor];
