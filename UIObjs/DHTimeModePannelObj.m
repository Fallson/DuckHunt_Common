...
-(id) initWithWinRect: (CGRect)rect
{
	if( (self=[super init]) )
    {
        ...
        self.left_time_label = [DHLabel labelWithString:left_time_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
        self.left_time_label.color=[DHLabel GetColor];
