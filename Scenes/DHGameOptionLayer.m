...
-(void)initOption
{
    ...
    mi_bgMusic.scale *= 0.5*CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
    ...
    DHLabel* bgMusic_label = [DHLabel labelWithString:bgMusic_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
    ...
    mi_gameMusic.scale *= 0.5*CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
    ...
    DHLabel* gameMusic_label = [DHLabel labelWithString:gameMusic_str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
