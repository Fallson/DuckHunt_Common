...
-(void)initScores
{
    ...
    DHLabel* lable = [DHLabel labelWithString:str fontName:DHLABEL_FONT fontSize:24*[[DHGameData sharedDHGameData] getScale]];
    lable.color = [DHLabel GetColor];
...
-(void)initMenu
{
    ...
    DHLabel* return_label = [DHLabel labelWithString:return_str fontName:DHLABEL_FONT fontSize:20*[[DHGameData sharedDHGameData] getScale]];
    return_label.color=ccBLUE;
    return_label.position = ccp(_bgRect.origin.x + _bgRect.size.width*0.5, _bgRect.origin.y + 0.15*_bgRect.size.height);
    ...
    menuitem_return.scale *= CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale];
    ...
    menuitem_twitter.scale *= (0.25 * CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale]);
    ...
    menuitem_facebook.scale *= (0.25 * CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale]);
    ...
    menuitem_weibo.scale *= (0.25 * CC_CONTENT_SCALE_FACTOR()*[[DHGameData sharedDHGameData] getScale]);
